...
import { Bedroomtoggle, cityToggle, PriceData, TypeDataToggle } from '../../Data/CityToggle'
...
export default function RealStateHeader() {
    ...
    const HandleZipCountry = (item) => {
        ...
        const cityValue = cityToggle.filter(value => value.zip_code === item.zip_code)
    ...
    return (
        <div id="search-filter" className={`showRefId ${scrollValue > 120 ? `${state ? '' : 'fixed'}` : ''} `}>
            <div id="search" className="sec-search ">
                <div className="search-functioned wrap-dis-85 wrap wrap-tab-11 wrap-mob-11">
                    ...
                    <div className="search-input-wrap flex wrappping-hidden  ">
                        <div
                            className={`${openLocation ? 'open' : ''} search-filter-input search-filter-input-city originValue cursor-pointer`}
                            linktype="location"
                        ...
                        >
                                    ...
                                    <ul>
                                        {
                                            cityToggle.map((item) => {
                                                return (
                                                    <label className="checkbox-container" onClick={() => HandleCity(item)}>
                                                        {item.County}
                                                        <input
                            ...
                            <span className="search-filter-input-title relative h-[40px]  text-mdd-center">
                                <p className={`absolute ${cityData ? 'text-sm top-1' : 'text-md top-3'} `}>City</p>
                                <p className='absolute -bottom-2'>{cityData}</p>
                                {
                                    cityData && <RxCross2 onClick={HandlecloseCity} color={'#5018ff'} className="absolute right-2 top-3  text-2xl font-black" />
                                }
                            </span>
                            <i className={`${openLocation ? 'fa-solid fa-angle-up' : "fa-solid fa-angle-down"}  search-filter-input-icon pp-0`} />
                        ...
                        {/*----------------------------------------------A R E A---------------------------------------------------------*/}
                        {/*----------------------------------------------T Y P E S---------------------------------------------------------*/}
                        <div onClick={HandleOpenType} className={` ${openType ? 'open' : ''} search-filter-input originValue cursor-pointer`} linktype="type">
                            <div className="filter-type-dropdown-wrap">
                                <div className="filter-type-dropdown">
                                    <h4>Type</h4>
                                    <ul>
                                        {
                                            TypeDataToggle.map((item) => {
                                                return (
                                                    <label className="checkbox-container" onClick={() => HandleTypeData(item)}>
                                                        {item.link}
                                                        <input
                            ...
                            <span className="search-filter-input-title h-[40px] relative text-mdd-center">
                                ...
                                <p className={`absolute ${typeData ? 'text-sm top-1' : 'text-lg top-3'}`}>Type</p>
                                <p className={'absolute -bottom-3'}>{typeData}</p>

                                {
                                    typeData && <RxCross2 onClick={handleTypeClose} color={'#5018ff'} className="absolute right-1 top-3  text-2xl font-black" />

                                }
                            </span>
                            <i className={`${openType ? 'fa-solid fa-angle-up' : 'fa-solid fa-angle-down'} search-filter-input-icon`} />
                            <div className="search-filter-input-dropdown  anchor">
                                {
                                    TypeDataToggle.map((item) => {
                                        return (
                        ...
                        >
                            <span className="search-filter-input-title relative" onClick={HandlePriceToggle}>

                                <p className={`absolute ${minPriceInputValue ? 'top-1 text-sm' : 'top-3 text-md'}`}>Price</p>
                                <p className={`absolute top-5`}>{minPriceInputValue ? minPriceInputValue + '-' : ''}{maxPriceInputValue ? maxPriceInputValue : ''}</p>
                                {
                                    minPriceInputValue && <RxCross2 onClick={() => {
                                        setminPriceInputValue('')
                                        setmaxPriceInputValue('')
                                    }} color={'#5018ff'} className="absolute right-2 top-3  text-2xl font-black" />
                                }
                            ...
                            <i className={`${openPrice ? 'fa-solid fa-angle-up' : 'fa-solid fa-angle-down'} search-filter-input-icon`} onClick={HandlePriceToggle} />
                                            ...
                                            <ul className={`${minPrice ? 'open' : ''}`}>
                                                {
                                                    PriceData.map((item) => {
                                                        return (
                                                            <label className="checkbox-container" onClick={() => setminPriceInputValue(item.dollar)}>
                                        ...
                                        <div className="maxPrice">
                                            ...
                                            <ul className={`${maxPrice ? 'open' : ''}`}>

                                                {
                                                    PriceData.map((item) => {
                                                        return (
                                                            <label className="checkbox-container" onClick={() => setmaxPriceInputValue(item.dollar)}>
                        ...
                        >
                            ...
                            />
                            <span className="search-filter-input-title relative h-[40px] text-mdd-center">
                                <p className={`absolute ${BedroomData ? 'text-sm top-1' : 'text-lg top-3'}`}> Bedrooms</p>
                                <p className={`absolute -bottom-3`}>{BedroomData}</p>

                                {
                                    BedroomData && <RxCross2 onClick={() => setBedroomData('')} color={'#5018ff'} className="absolute right-2 top-3  text-2xl font-black" />
                                }
                            </span>
                            <i className={`${openBedroom ? "fa-solid fa-angle-up" : "fa-solid fa-angle-down"} search-filter-input-icon`} />
                            <div className="filter-type-dropdown-wrap">
                                <div className="filter-type-dropdown">
                                    <h4> Bedrooms </h4>
                                    <ul>
                                        {
                                            Bedroomtoggle.map((item) => {
                                                return (
                                                    <label className="checkbox-container" onClick={() => HandleBedroom(item.link)}>
                                                        {item.link}
                                                        <input
                                                            defaultValue={0}
                                                            type="radio"
                        ...
                        >
                            ...
                            />
                            <span className="search-filter-input-title relative h-[40px] text-mdd-center">
                                <p className={`absolute ${zip_code ? 'text-sm top-1' : 'text-lg top-3'}`}> Zip Code</p>
                                <p className={`absolute -bottom-3`}>{zip_code}</p>

                                {
                                    zip_code && <RxCross2 onClick={() => setzip_code('')} color={'#5018ff'} className="absolute right-2 top-3  text-2xl font-black" />
                                }
                            </span>
                            <i className={`${openBedroom ? "fa-solid fa-angle-up" : "fa-solid fa-angle-down"} search-filter-input-icon`} />
                                    ...
                                    <ul>
                                        {
                                            cityToggle.map((item) => {
                                                return (
                                                    <label className="checkbox-container" onClick={() => HandleZipCountry(item)}>
                                                        {item.zip_code}
                                                        <input
                                                            defaultValue={0}
                                                            type="radio"
                        ...
                        >
                            <i
                                className="fa fa-search text-[#5081ff]"
                                aria-hidden="true"
                            />
                            Search
                        </button>
                ...
                <div className="default-search">
                    ...
                    <div className="search-filter-input minPrice">
                        <span className="search-filter-input-title" value="" type="minPrice">
                            Min Price <i className="search-filter-input-value" />
                        </span>
                        <i className="fa fa-angle-down search-filter-input-icon" />
                        <div className="search-filter-input-dropdown">
                    ...
                    <div className="search-filter-input maxPrice">
                        <span className="search-filter-input-title" value="" type="maxPrice">
                            Max Price <i className="search-filter-input-value" />
                        </span>
                        <i className="fa fa-angle-down search-filter-input-icon" />
                        <div className="search-filter-input-dropdown">
                    ...
                    <div className="search-filter-buttons">
                        <Button id="createSearchData" type="button" className="primary btn text-[#fff] hover:text-[#5218ff]">
                            Search
                        </Button>
                        <span className="or-seperator">OR</span>
                        <Link
