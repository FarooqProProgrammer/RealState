                      ...
                      <div className="row no-gutters shadow-card">
                        ...
                        <div className="col-md-8">
                          <div className="card-body card-body-blog">
                            ...
                            <span className="propertynews-span max-h-[200px]" limit={300}>
                              {/* <Truncate lines={3} ellipsis={<span>... <a href='/link/to/article'>Read more</a></span>}> */}

                              <RawHTMLRenderer html={item.value} className={'max-h-[100px] overflow-y-hidden'} />
                              {/* </Truncate> */}
                            </span>
            ...
            <div className="container">
              <div className="continue-readingg">
                <p>
                  ...
                  things Turkish, including tips about life in Turkey, Turkish
                  culture, economic &amp; political matters and how to get the best
                  out of your home and investment. Showcasing many case studies of
                  those who invested and/or moved to Turkey and integrated into the
                  Turkish lifestyle, this blog is your informative guide for all you
                  need to know about making the big move overseas to Turkey.&nbsp;
                </p>
                <p>
                  <br />
                </p>
                <p>
                  ...
                  Istanbul, Kas, Side, and more - you can expect us to blog weekly
                  about the latest trends, case studies and news coming out of the
                  top cities in Turkey. Also expect several investment tips and hot
                  tips for real estate and properties that are hot and ready to sell
                  now.&nbsp;
                </p>
              </div>
            </div>
