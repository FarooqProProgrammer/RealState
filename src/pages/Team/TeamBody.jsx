        ...
        <div className="page-content-container wrap-dis-9 wrap wrap-tab-11 wrap-mob-11 ">
            <article className="page-content col-dis-9 col-tab-9 col-mob-12 no-padding">
                ...
                >
                    ...
                    <p>
                        Our Bodrum Office has been in operation for more than a decade. We've
                        watched the peninsula evolve from a series of sleepy fishing villages
                        into a centre for luxury tourism and real estate.
                    </p>
                    <p>
                        Our dedicated, dynamic team covers the peninsula from top to bottom,
                        sourcing properties, liaising with developers and of course, showing the
                        area we love so much to our clients. If you find yourself in Bodrum,
                        head to the harbour -{" "}
                        <Link

                        >
                            our offices are right on the waterfront
                        </Link>
                        .
                    </p>
                    <p>
                        Drop in, order a coffee from one of our baristas and have a chat with
                    ...
                    </p>
                    {
                        Team.map((item) => {
                            return (
                                <TeamCardComponent name={item.name} img={item.img} descriptionOne={item.Desc} desgination={item.Desig} />
                            )
                        })
                    }
                ...
                <div className="cameron-section-aboutus">
                    <div className="col-12 col-md-9 no-padding">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-9 cameron-section-quotesbg flex items-center">
                                        <p className="cameron-section-blackquote">
                                            “Property Turkey is different: our interests lie with you, the
                                            buyer. Contrary to industry practices, we don’t receive any
                                            payments from sellers, which means we maintain our
                                            independence and can focus on securing you the best possible
                                            terms. We aim to provide candid, expert advice on everything
                                            Turkey, from lifestyle purchases to investment. We know you’re
                                            not just buying bricks and mortar - but making an investment
                                            into your lifestyle. From first contact to rental management,
                                            we’ll be by your side to guide and assist you."
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <p className="margin-top-3">
                            ...
                            <span style={{ lineHeight: "1.6em" }}>&nbsp;or via email&nbsp;</span>
                            <Link  >
                                <em style={{ lineHeight: "1.6em" }}>
                            ...
                            <span style={{ lineHeight: "1.6em" }}>
                                &nbsp;and one of our knowledgeable and friendly team will get back
                                to you with the advice and assistance that you need.
                                <br />
                                <br />
