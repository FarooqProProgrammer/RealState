                        ...
                        <Box className="card-body card-body-blog">
                            <Typography varient="p" className="propertynews-date">
                                <span>
                                    ...
                                    <span className="clr-pt-dark">
                                        <Link
                                            to="related-blogs/keyword?keyword="
                                            title=""
                                        />
                                    </span>
                                    &nbsp;&nbsp;/&nbsp;&nbsp; 03 May 2023
                            ...
                            <span className="propertynews-span" limit={300}>
                                ...
                                Bosporus Strait, has captivated empires, artists, and
                                travellers for centuries. Alongside the naval traffic, this
                                narrow, winding waterway of north western Turkey meanders
