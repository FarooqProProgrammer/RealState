                ...
                >
                    ...
                    <Box className="section--filter-wrapper">
                        <ul className="popular-cities section--filter " style={{}}>
                            ...
                            <li>
                                <Link onClick={() => setData('California')} className="btn section--filter-Link " rel="Istanbul">
                                California
                                </Link >
                            </li>
                            
                            <li>
                                <Link onClick={() => setData('San Francisco')} className="btn section--filter-Link " rel="Istanbul">
                                San Francisco
                                </Link >
                            </li>
                        </ul>
                    ...
                    <ElasticSlider ItemShop={4}>
                        ...
                        {
                            propertiesData.filter(item => item.property_Location === data).map((item) => {
                                return (
                                    <Box
                                        key={item.id}
                                        style={{ width: 300 }}
                      ...
                      prevent-newtab-onmobile"
                                            ...
                                            <Box className="features skelton-loading">
                                                <Box className="location">
                                                    <img alt="pic 08"
                                                        ...
                                                        src={LocationSvg}
                                                    />
                                                    <span className="quantity">{item.property_Location}</span>
                                                </Box>
                                                <Box className="bedrooms flex content-space-evenly">
                                                    ...
                                                    <Box>
                                                        <span className="quantity">{item.property_BedRoom}</span>
                                                    </Box>
                                                </Box>
                                                <Box className="bathrooms flex content-space-evenly padding-left-05">
                                                    ...
                                                    <Box>
                                                        <span className="quantity">{item.Propert_Bathroom}</span>
                                                    </Box>
                                                </Box>
                                                <Box className="quantity  padding-dir-05">{item.Propert_Living_space}</Box>
                                            </Box>
                                            <Box className="card-actions flex padding-1 content-space-between skelton-loading">
                                                ...
                                                >
                                                    <span className="unit-price flex">{item.Property_Price}</span>
                                                </Box>
                                                <Box>
                                                    <Link
