...
import { FooterAboutUs, FooterLinksBuyerGuideData, FooterLinksPopularLocationsData, FooterLinksPopularSearchesData } from '../../Data/FooterLinksData';
...
export default function Footer() {
  ...
  return (
    <footer style={{ display: location.pathname === '/printPreview' ? 'none' : '' }}>
        ...
        <Box className="wrap-dis-85 wrap wrap-tab-11 wrap-mob-11">
          <Box className="row padding-top-1">
            <Box className="col-4 col-md-2">
              ...
              <Link className="margin-top-05 clr-brightpt-grey expand">
