...
import { cityToggle, TypeDataToggle, Bedroomtoggle, PriceData } from '../../Data/CityToggle'
...
export default function HeroSection() {
    ...
    const [locationToggleName, setlocationToggleName] = React.useState('Location')
    ...
    return (
        <section className={`bg-pt-off-white ${states ? '-z-50 absolute' : 'z-50 '} `}>
            <input type="hidden" id="currentCurrency" />
            <Box
                className="tab-content d-block position-relative abhaya"
                id="myTabContent"
                style={{ backgroundImage: `url(${HomeBanner[index].img})`,backgroundRepeat: 'no-repeat',backgroundSize: 'cover',backgroundPosition: 'center' }}

            >
                <Box className={`tab-pane home-tab fade ${tabOneActive ? '' : 'show active'}`} id="tab-1">
                        ...
                        <Box className="card container-pt bg-transparent border-0">
                            ...
                            >
                                ...
                                <Box className="row" id="search">
                                    {/*----------------- L O C A T I O N ------------------*/}
                                    <Box className="col-lg-2 col-md-4 col-12 mb-4" onClick={LocationToggle}>
                                        <Box
                                            className={`${locationtoggle ? 'hasValue' : 'open'} search-filter-input search-tab-input search-location-input originValue`}
                                            linktype="location"
                                        >
                                            ...
                                            <span className="search-filter-input-title relative h-[40px]  search-tab-input-title bold py-3 text-center px-0">
                                                <p className={`block mb-0 font-black absolute ${CityData ? 'text-sm top-1' : 'text-lg top-3'}`}>{locationToggleName}</p>

                                                <p className={`block mb-0 font-black absolute bottom-0 text-sm`}>{CityData}</p>
                                    ...
                                    {/*------------------- T Y P E S ---------------------*/}
                                    <ColumnBox onClick={TypeToggle} className="col-lg-2 col-md-4 col-12 mb-4">
                                        <div
                                        ...
                                        >
                                                    ...
                                                    <ul>
                                                        {
                                                            TypeDataToggle.map((item) => {
                                                                return (
                                                                    <label className="checkbox-container" onClick={() => TypeDataHide(item)}>
                                            ...
                                            <span className="search-filter-input-title relative text-center h-[40px] search-tab-input-title fs-5 fw-bold px-0">
                                                <p className={`absolute top-3 ${TypeData ? "text-sm" : "text-md"}`}>Type</p>
                                    ...
                                    {/*------------------- P R I C E S ---------------------*/}
                                    <ColumnBox className="col-lg-2 col-md-4 col-12 mb-4" onClick={PricesToggle}>
                                        <Box
                                            className={`${PriceToggle ? '' : 'open'} h-[45px] py-3 originValue search-filter-input search-tab-input d-lg-flex price-toggle`}
                                            id="price-toggle"
                                        >
                                            <span className="search-filter-input-title relative search-tab-input-title fs-5 fw-bold px-0">
                                                
                                                <p className={`absolute ${minimumPriceValue || maximumPriceValue ? 'text-sm -top-3 font-bold':"text-xl -top-3 font-bold"} `}>Price</p>
                                                <p className='absolute text-sm'>{minimumPriceValue}-{maximumPriceValue}</p>
                                                ...
                                                <Box className="filter-type-dropdown">
                                                    ...
                                                    <Box>
                                                            ...
                                                            <ul className={`${minimunPrice ? 'open' : ''}`}>
                                                                {
                                                                    PriceData.map((item) => {
                                                                        return (
                                                                            <label className="checkbox-container" onClick={() => SetMinmimumValue(item)}>
                                                                                {" "}
                                                                                {item.dollar}
                                                                                <input
                                                                                    defaultValue={0.0}
                                                        ...
                                                        <Box className="maxPrice">
                                                            ...
                                                            />
                                                            <ul className={`maxPriceValues ${maximumPrice ? "open" : ""}`}>
                                                                {
                                                                    PriceData.map((item) => {
                                                                        return (
                                                                            <label className="checkbox-container" onClick={()=>HandleMaximun(item)}>
                                                                                {item.dollar}
                                                                                <input
                                    ...
                                    {/*----------------- B E D R O O M S ------------------*/}
                                    <ColumnBox onClick={BedToggle} className="col-lg-2 col-md-4 col-12 mb-4">
                                        <Box
                                            className={`${BedRom ? '' : 'open'} h-[45px] search-filter-input search-tab-input bedrooms`}
                                            linktype="bedrooms"
                                            id="bedroom-toggle"
                                        >
                                            <span className="search-filter-input-title relative text-center h-[40px] search-tab-input-title fs-5 fw-bold px-0">
                                                <p className={`absolute top-3 ${BedroomData ? "text-sm" : "text-md"}`}>Bedroom</p>
                                                <p className="absolute -bottom-4 text-sm">{BedroomData}</p>
                                            </span>
                                            <Box
                                                className="search-filter-input-title relative"
                                                style={{ width: "fit-content !important" }}
                                    ...
                                    {/*--------------------- T A G S ----------------------*/}
                                    {/*--------------------- R E F E R E C E ----------------------*/}
                                    <Box onClick={HandleZipCode} className="col-lg-2 col-md-4 col-12 mb-4 cursor-pointer">
                                        <Box
                                            className={`${HandleZip ? '' : 'open'} h-[45px] search-filter-input search-tab-input bedrooms`}
                                            linktype="bedrooms"
                                            id="bedroom-toggle"
                                        >
                                            <span className="search-filter-input-title relative text-center h-[40px] search-tab-input-title fs-5 fw-bold px-0">
                                                <p className={`absolute ${HandleZipInput?'top-1 text-sm':'top-3 text-lg'}`}>Zip Code</p>
                                                <p className={`absolute top-5 text-md`}>{HandleZipInput}</p>
                                            </span>
                                            <Box
                                                className="search-filter-input-title relative"
                                                style={{ width: "fit-content !important" }}
                                                    ...
                                                    <ul className="h-[200px] overflow-y-auto">
                                                        {
                                                            cityToggle.map((item) => {
                                                                return (
                                                                    <label className="checkbox-container" onClick={()=>handleValue(item)}>
                                                                         {item.zip_code}
                                                                        <input
